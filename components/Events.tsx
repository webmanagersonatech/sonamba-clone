            ...
            <AnimatePresence mode="wait">
              ...
              >
                <MotionLink
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 py-2 bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 text-maroon rounded-full font-bold shadow-md hover:bg-yellow-400 transition-colors"
                >
                  {activeTab === "News"
                    ? "View All News"
                    : activeTab === "Events"
